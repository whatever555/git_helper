$(document).ready(function(){
    ...
    chrome.storage.sync.get('disabled', function(itemz) {
        ...
        if (typeof disabled !== typeof undefined && disabled !== false) {
         ...
         if (disabled)
         {
             ...
             $('.tabnav-pr').append('<a class="tabnav-tab js-pjax-history-navigate" id="gl-actions-enable">'+svgCode+'Enable '+appName+'</a>');
         }
    });
    ...
    function showMessage(message, extraClass='', append=false, noToast=false){
        ...
        {
            $("<div class='gitlint-message'></div>").insertAfter('.tabnav-pr');
    ...
    function loadMenuButton(noLink=true){
        ...
        $('.tabnav-pr').append('<a '+link+' class="tabnav-tab js-pjax-history-navigate" id="gl-helper-tab-button">'+iconCode+appName+'</a>');
...
function showHideUI(){
    ...
    if ($("#gl-lint-options").attr('visible')=="true")
    {
        ...
        $('.tabnav-pr a').removeClass('selected');
    ...
    function loadMenu(){
        ...
        $( "<div id='gl-lint-options' class='"+statusClass+"'></div>" ).insertAfter( ".tabnav-pr" );
